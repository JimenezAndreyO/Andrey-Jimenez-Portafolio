...
const projects = [
  ...
  },
  {
    ...
    {
    title: "Manejo de API hoteles",
    description: "Sistema de gestión de Reservaciones, Habitaciones y Personas, para administrar y manejar ingresos, reservacion (API)",
    image: "/Imagenswaggerhotel.png",
    github: "https://github.com/JimenezAndreyO/API-Hoteles.git",
    tech: ["C#", "SQL", "WEB", "API", "MVC", "RESTFULL", "Entity Framework"],
